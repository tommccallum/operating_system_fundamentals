...
.set KERNEL_OFFSET, 0x1000              # where we load our kernel, matches our -T argument to the linker when compiling our kernel
...
load_kernel:
  mov $MSG_LOAD_KERNEL, %si         # give the user a message
  call print_string
...
BEGIN_PROTECTED_MODE:
  ...
  call KERNEL_OFFSET                  # now jump to our favourite kernel
